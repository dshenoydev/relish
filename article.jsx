// Relish — Article page (the actual blog post)

const { useState: useArtS, useEffect: useArtE } = React;
    ...
    <nav className="nav">
      <div className="shell nav-row">
        ...
        <div className="profile-crumbs">
          ...
          <span>/</span>
          <a href="Relish — Homepage.html#nutrition">Nutrition</a>
          <span>/</span>
          <b>Protein, explained</b>
        </div>
        <a href="Relish — Creator.html" className="nav-cta">Read more by Marcus →</a>
      </div>
    </nav>
  );
}
    ...
    <header className="article-hero">
      <div className="shell article-hero-grid">
        <div className="article-hero-meta">
          <a href="Relish — Homepage.html#nutrition" className="article-tag-link">{ARTICLE.tag}</a>
          <h1 className="article-hed">{ARTICLE.hed}</h1>
          <p className="article-dek">{ARTICLE.dek}</p>

          <div className="article-byline">
            <a href="Relish — Creator.html" className="byline-author">
    ...
    <section className="related-section">
      <div className="shell">
        <div className="section-head">
          ...
          <a href="Relish — Creator.html" className="btn btn-ghost btn-arrow">All his articles</a>
        </div>
      ...
      <div className="shell">
        <div className="footer-top" style={{ gridTemplateColumns: "1.6fr 1fr 1fr" }}>
          ...
          <div className="footer-col">
            ...
            <ul>
              <li><a href="Relish — Homepage.html#diets">Diets compared</a></li>
              <li><a href="Relish — Homepage.html#myths">Myth-busted</a></li>
              <li><a href="Relish — Homepage.html#experts">Contributors</a></li>
          ...
          <div className="footer-col">
            ...
            <ul>
              <li><a href="Relish — Creator.html">About Marcus</a></li>
...
const ARTICLE_TWEAKS = /*EDITMODE-BEGIN*/{
...
function ArticleApp() {
  ...
  useArtE(() => { applyArticlePalette(t.palette); }, [t.palette]);
  return (
    <>
      <ArticleNav />
      <main>
