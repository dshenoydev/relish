    ...
    <nav className="nav">
      <div className="shell nav-row">
        ...
        <div className="profile-crumbs">
          ...
          <span>/</span>
          <a href="Relish — Homepage.html#experts">Experts</a>
          <span>/</span>
          <b>{PROFILE.short}</b>
        </div>
      ...
      <div className="shell">
        <div className="footer-top" style={{ gridTemplateColumns: "2fr 1fr 1fr" }}>
          ...
          <div className="footer-col">
            ...
            <ul>
              <li><a href="Relish — Homepage.html#experts">All contributors</a></li>
...
function ProfileApp() {
  ...
  useCE(() => { applyProfilePalette(t.palette); }, [t.palette]);
