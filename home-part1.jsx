// Relish — Homepage React components
// Exposes <Homepage /> on window.
...
function Nav({ active, onJump, logoVariant }) {
  return (
    <nav className="nav">
...
/* ─── Hero ───────────────────────────────────────────────────────────── */
function Hero({ headline, sub, paths }) {
  return (
    <section id="top" className="hero">
      <div className="shell hero-grid">
        <div className="hero-left">
          ...
          <a href="Relish — Article.html" className="latest-article">
...
window.RelishHome1 = { Nav, Hero, DietsSection, MythsSection };
