        ...
        <div className="quiz-options">
          {QUIZ_OPTS.map((q, i) =>
            <button
              ...
              onClick={() => setPicked(i)}
              style={{ borderColor: "rgb(100, 140, 82)", backgroundColor: "rgb(118, 155, 86)" }}>
              {q}
            </button>
          )}
        </div>
          ...
          {EXPERTS.map((x, i) =>
            <article key={i} className="expert-card">
              ...
              <div className="expert-body">
                ...
                <a href="/creator" className="expert-link">Read their takes →</a>
              </div>
            </article>
          )}
        </div>
      ...
      <div className="shell">
        <div className="footer-top">
          <div className="footer-brand">
            ...
            <p style={{ color: "rgba(244,237,221,0.7)", marginTop: 22, maxWidth: 36 + "ch" }}>
              Whole foods, honestly. Run by an Indian woman and a small collective of contributors who read, test, and research for you.
            </p>
          </div>
          {cols.map((c, i) =>
